    ...
    allMappings = {
        "CouchbaseServer": {
            "4.6.3": {
                ...
                "us-west-2": { "BYOL": "ami-1da63565", "HourlyPricing": "ami-49a11e31" },
...
def generateServer(group, rallyAutoScalingGroup):
    ...
    command = [
        ...
        "stackName=", { "Ref": "AWS::StackName" }, "\n",
        "baseURL=https://raw.githubusercontent.com/pearsontechnology/amazon-cloud-formation-couchbase/master/scripts/\n",
